...
ScopeItem.prototype.addWrite = function (node) {
    if (this.isConstant && this.writes.length) {
        this.scope.emitError('Assigning to constant `%s', this.name);
    }
    else {
...
ScopeItem.prototype.getSingleWrite = function () {
    if (this.init && !this.writes.length) {
        return this.init;
    }
